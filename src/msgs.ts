export const msgs_texto = {
    ...
    geral: {
        ...
        comando_invalido:
            '[❗] Parece que você não digitou corretamente o comando ou não sabe como usá-los, digite o comando *!menu* para mais informações.',
        cmd_erro:
    ...
    grupo: {
        ...
        bemvindo: {
            ...
            mensagem: '👋 Olá, @{p1}\n' + 'Seja bem vindo(a) ao grupo *{p2}*\n\n' + '{p3}' + 'Digite *!menu* para ver os comandos.',
        },
        status: {
    ...
    admin: {
        ...
        usuarios: {
            nao_encontrado:
                '[❗] Não existem usuários com esse tipo ou você digitou um tipo inválido, confira os tipos disponíveis em *!tipos*',
