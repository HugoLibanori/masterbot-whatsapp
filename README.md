...
## case vc queira usar o bot com PM2 rode o comando npx tsc para compilar os arquivos da pasta ./dist. lá será criado todos os arquivos em JS rode o comando pm2 start ./dist/app.js, assim o bot vai rodar normal.
